...
class TitleTrigger(WordTrigger):
    ...
    def evaluate(self, story):
        ...
        result = wordTrig.isWordIn(story.getTitle().lower())
        return result
...
class SubjectTrigger(WordTrigger):
    ...
    def evaluate(self, story):
        wordTrig = WordTrigger(self.word)
        result = wordTrig.isWordIn(story.getSubject().lower())
        return result
...
class SummaryTrigger(WordTrigger):
    ...
    def evaluate(self, story):
        wordTrig = WordTrigger(self.word)
        result = wordTrig.isWordIn(story.getSummary().lower())
        return result
...
class PhraseTrigger(Trigger):
    ...
    def evaluate(self, story):
        if self.phrase in story.getTitle(): return True
        if self.phrase in story.getSubject(): return True
        if self.phrase in story.getSummary(): return True
        return False
...
def main_thread(master):
    ...
    try:
        ...
        triggerlist = readTriggerConfig("/Users/oybektoirov/Documents/ProblemSet7/triggers.txt")
